...
public class ATMOperations {
	...
	public static IATMService validCredentials(long cardNumber, int pinNumber)
			throws InvalidCardException, InvalidPinException, InvalidPinException {
		if (dataBase.containsKey(cardNumber)) {
		...
		if (card.getChances() >= 3) {
			throw new InvalidPinException("you have reached wrong limit of pin number which is 3  attempts ");
		}
		if (card.getPinNumber() != pinNumber) {
	...
	public static void validateAmount(double amount) throws InsufficientMachineBalnaceException {
	...
	public static void validateDepositeAmount(double amount)
		...
		if (amount + ATM_MACHINE_BALANCE > 1200000.0d) {
			...
			throw new InsufficientMachineBalnaceException("you can't deposite cash as limit of atm machine ");
		}
	}
	...
	public static void operatorMode(IATMService card) {
		...
		while (flag) {
			...
			case 2:
				...
				} catch (InsufficientMachineBalnaceException e) {
					System.out.println(e.getMessage());
				}
				break;
			case 3:
	...
	public static void main(String[] args) throws NotAOperatorException, IncorrectPinLimitReachedException {
		...
		while (MACHINE_ON) {
			...
			} catch (InvalidPinException | InvalidCardException e) {
